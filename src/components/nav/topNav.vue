  ...
  <el-row class="container">
    ...
    <el-col :span="24" class="topbar-wrap">
      ...
      <div class="topbar-logos">
        <a href="/" style="color: #fff;"><span v-show="!$store.state.collapsed">智能粮库管理平台</span></a>
      </div>
      <div class="topbar-title">
        ...
        <el-row v-show="$store.state.topNavState==='home'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/enterpriseManager">专家决策分析</el-menu-item>
              <el-menu-item index="/orderManager">储备粮管理</el-menu-item>
              <el-menu-item index="/systemManager">购销经营管理</el-menu-item>
              <el-menu-item index="/">出入库</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
        <el-row v-show="$store.state.topNavState==='enterprise'">
          <el-col :span="24">
            <el-menu :default-active="defaultActiveIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
              <el-menu-item index="/enterpriseManager">专家决策分析</el-menu-item>
              <el-menu-item index="/vehicleManager">储备粮管理</el-menu-item>
              <el-menu-item index="/deptManager">购销经营管理</el-menu-item>
              <el-menu-item index="/">出入库</el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      ...
      <div class="topbar-account topbar-btn">
        <el-dropdown trigger="click">
          <span class="el-dropdown-link userinfo-inner">
            <i class="iconfont icon-user"></i> 崔凯航   <i class="el-icon-caret-bottom"></i></span>
